...
export default function Investimento() {
  return (
    <section id="investimento" className="bg-[color:var(--surface-soft)] py-28 md:py-36">
        ...
        <div className="md:col-span-5">
          ...
          <Reveal delay={0.05}>
            <h2 className="mt-4 font-serif text-5xl leading-[1.05] text-[color:var(--foreground)] md:text-6xl">
              Um portal aberto{" "}
              <span className="accent-text not-italic md:italic">para poucas.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-6 leading-relaxed text-[color:var(--muted-foreground)]">
              A Ciranda acontece em formato íntimo para preservar a profundidade da experiência. As
              vagas são limitadas e seguem por ordem de confirmação.
            </p>
          </Reveal>
          <Reveal delay={0.15}>
            <ul className="mt-8 space-y-3">
              {incluso.map((i) => (
                <li key={i} className="flex items-start gap-3 text-sm text-[color:var(--foreground)]">
            ...
            <div className="relative overflow-hidden rounded-[26px] border border-[color:var(--border-soft)] bg-[color:var(--surface-card)] p-8 shadow-[0_40px_80px_-40px_rgba(75,40,20,0.4)] md:p-10">
              ...
              <div className="mt-7 flex items-end gap-3">
                <p className="font-serif text-7xl leading-none text-[color:var(--foreground)] md:text-8xl">
                  R$ 585<span className="text-3xl text-[color:var(--muted-foreground)]">,00</span>
                </p>
              </div>
              ...
              <div className="mt-6 flex items-center gap-3 rounded-2xl border border-[color:var(--accent-rose)] bg-[color:var(--accent-rose)]/30 px-4 py-3">
                ...
                <p className="text-sm text-[color:var(--foreground)]">
                  ...
                  <strong className="text-[color:var(--primary)]">10% de desconto</strong> na sua
                  vaga.
                </p>
              </div>
              ...
              <a href="#formulario" className="btn-primary mt-7 w-full justify-center">
                Garantir minha vaga
              </a>
